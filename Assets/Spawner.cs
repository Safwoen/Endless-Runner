...
public class Spawner : MonoBehaviour
{
    ...
    public float maxSpawnTime = 3.0f; //Maximum of time between spawning objects
    void Start()
    {
    ...
    void Update()
    {
        ...
        if (timeSinceLastSpawn > timeToNextSpawn)
        {
            ...
            //Instiantiate spawns a Gameobject  - in this case we will tell it to spawn a Gameobject from our objectsToSpawn list
            ...
            //After spawning, we select a new random time for the next time for the next spawn and set our timer back to zero
            timeToNextSpawn = Random.Range(minSpawnTime, maxSpawnTime);
